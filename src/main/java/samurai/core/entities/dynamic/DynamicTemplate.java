...
import samurai.core.command.util.Template;
...
public class DynamicTemplate extends DynamicMessage {
    ...
    public Message getMessage() {
        // You want to use a MessageBuilder to build your entities
        ...
        switch (getStage()) {
            ...
            case 1:
                ...
                break;
            case 2:
                mb.append("<@").append(getReaction().getUserId()).append("> is a monster.");
                break;
            case 3:
                mb.append(" gagagsga.");
                break;
    ...
    /**
     * This method changes the entities based on the current Reaction
     */
    @Override
    protected void execute(ReactionEvent action) {
        ...
        switch (action.getName()) {
            ...
            case "👥":
                ...
                break;
            default:
                Bot.logError(new AccessControlException(String.format("Invalid reaction allowed access to execute%n%s by %s", action.getName(), action.getUserId())));
        }
    }
     ...
     *
     * @return a consumer to edit entities after sending
     */
    @Override
    public Consumer<Message> createConsumer() {
        ...
        switch (getStage()) {
            case 0:
                ...
                // you can use this method to pre-add reactions to entities
    ...
    /**
     * marks the final form of the dynamic entities
     *
