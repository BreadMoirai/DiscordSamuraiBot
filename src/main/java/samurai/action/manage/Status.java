...
public class Status extends Action {
    ...
    protected SamuraiMessage buildMessage() {
        ...
        final EmbedBuilder embed = new EmbedBuilder()
                ...
                .addField("Messages", String.format("**%-15s**`%d`%n**%-20s**`%d`%n**%-14s**`%.2f`", "received:", Bot.CALLS.get(), "sent:", SamuraiListener.messagesSent.get(), "cmds/hr:", 360.0 * Bot.SENT.get() / ((System.currentTimeMillis() - Bot.initializationTime) / 1000.0)), true)
