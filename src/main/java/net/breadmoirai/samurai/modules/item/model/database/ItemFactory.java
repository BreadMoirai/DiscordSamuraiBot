...
public class ItemFactory implements RowMapper<Item> {
    ...
    public static List<Item> getAllItems() {
        return Database.get().withExtension(ItemDao.class, ItemDao::selectAllItems);
    }
    ...
    public static void load(ReadyEvent event) throws NoSuchObjectException {
        ...
        for (Item item : getAllItems()) {
            ...
            if (emote == null)
                throw new NoSuchObjectException("Emote for " + item.getData().getName() + " by id of " + item.getData().getProperties2()[1] + "was not found");
