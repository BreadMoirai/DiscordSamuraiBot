...
import net.breadmoirai.samurai.modules.item.model.BaseItem;
...
import net.breadmoirai.samurai.modules.item.model.data.ItemType;
import net.breadmoirai.samurai.modules.item.model.decorator.CrateVoucher;
import net.breadmoirai.samurai.modules.item.model.Item;
import net.breadmoirai.samurai.modules.item.model.decorator.PointVoucher;
