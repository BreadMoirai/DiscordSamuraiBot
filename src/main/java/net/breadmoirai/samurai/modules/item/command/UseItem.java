...
import net.breadmoirai.samurai.modules.item.ItemUseContextBuilder;
...
public class UseItem extends BiModuleCommand<ItemModule, PointModule> {
    ...
    public Response execute(CommandEvent event, ItemModule itemModule, PointModule pointModule) {
        ...
        return Responses.of("Please provide a valid index starting at 1 of the intended item in your inventory or provide the name of an item.");
    }
    ...
    private Response matchNum(String content, ItemUseContextBuilder iucb, Inventory authorInventory) {
        ...
        final ItemSlot baseItemSlot;
        {
            ...
            if (baseItemSlot == null) return Responses.of("There is no item in that slot");
        ...
        if (result == null) return Responses.of("Item" + baseItemSlot.getItem().print() + " cannot be used");
        return null;
    }
    ...
    private Response matchName(String content, ItemUseContextBuilder iucb, Inventory authorInventory) {
        ...
        if (use == null) return Responses.of("Item" + itemSlot.getItem().print() + " cannot be used");
        return use;
    }
