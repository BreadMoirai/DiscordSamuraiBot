...
public class Inventory {
    ...
    public List<ItemSlot> getItemSlots() {
        final ArrayList<ItemSlot> itemSlots = new ArrayList<>(DerbyDatabase.get().<ItemDao, List<ItemSlot>>openDao(ItemDao.class, itemDao -> itemDao.selectUserInventory(guildId, userId)));
    ...
    public void clear() {
        DerbyDatabase.get().<ItemDao>openDao(ItemDao.class, itemDao -> itemDao.deleteInventory(guildId, userId));
    }
}
