...
public class PointSession {
     ...
     */
    public void delete() {
        DerbyDatabase.get().<PointDao>openDao(PointDao.class, pointDao -> pointDao.deleteUser(discordId, guildId));
    }

    public void commit() {
        DerbyDatabase.get().<PointDao>openDao(PointDao.class, pointDao -> pointDao.update(discordId, guildId, points));
    }
